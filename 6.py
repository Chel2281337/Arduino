    ...
    def update_animation(self):
        ...
        if self.anim_state == 'opening':
            ...
            if pr >= 1:
                ...
                DOOR_STATES[self.serial_key] = True
            ...
            if pr >= 1:
                ...
                DOOR_STATES[self.serial_key] = False
...
# состояние дверей: True - открыта, False - закрыта
DOOR_STATES = {letter: False for letter in SERIAL_DOOR_MAP}
